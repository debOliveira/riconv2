...
class get_model(nn.Module):
    ...
    def __init__(self, num_class, n, normal_channel=True):
        ...
        self.sa0 = RIConv2SetAbstraction(npoint=512 * n,
                                         radius=0.12,
                                         nsample=8,
                                         in_channel=0 + in_channel,
                                         mlp=[32],
                                         group_all=False)
        self.sa1 = RIConv2SetAbstraction(npoint=256 * n,
                                         radius=0.16,
                                         nsample=16,
                                         in_channel=32 + in_channel,
                                         mlp=[64],
                                         group_all=False)
        self.sa2 = RIConv2SetAbstraction(npoint=128 * n,
                                         radius=0.24,
                                         nsample=32,
                                         in_channel=64 + in_channel,
                                         mlp=[128],
                                         group_all=False)
        self.sa3 = RIConv2SetAbstraction(npoint=64 * n,
                                         radius=0.48,
                                         nsample=64,
                                         in_channel=128 + in_channel,
                                         mlp=[256],
                                         group_all=False)
        self.sa4 = RIConv2SetAbstraction(npoint=None,
                                         radius=None,
                                         nsample=None,
